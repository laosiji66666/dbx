...
export default {
  ...
  meilisearch: {
    ...
    limit: "Limit",
    offset: "Offset",
    resultSummary: "About {count} results · {time} ms",
    viewJson: "JSON",
    viewTable: "Table",
    viewGrid: "Grid",
  ...
  dataCompare: {
    ...
    ignoredColumnsPlaceholder: "Comma-separated columns to ignore, e.g. created_at, updated_at",
    ignoredColumnsHint: "Value differences in these columns are excluded from the comparison. Columns are still read and kept in inserted rows during sync; applied globally across all compared tables.",
  ...
  settings: {
    ...
    sqlShortcutsDescription: "Custom SQL templates executed after selecting a table name in the SQL editor. Select a table identifier first; shortcuts with Cmd/Ctrl are recommended.",
    sqlShortcutsAdd: "Add",
