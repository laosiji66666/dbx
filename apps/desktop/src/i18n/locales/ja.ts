...
export default withEnglishFallback({
  ...
  meilisearch: {
    ...
    limit: "件数",
    offset: "オフセット",
    resultSummary: "約 {count} 件 · {time} ms",
    viewJson: "JSON",
    viewTable: "テーブル",
    viewGrid: "グリッド",
  ...
  dataCompare: {
    ...
    ignoredColumns: "無視する列",
    ignoredColumnsPlaceholder: "カンマ区切りで無視する列を指定（例: created_at, updated_at）",
    ignoredColumnsHint: "これらの列の値の差異は比較対象外になります。列自体は引き続き読み込まれ、追加行の同期では値が保持されます。複数テーブル比較ではすべてのテーブルに適用されます。",
