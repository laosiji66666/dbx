...
export default withEnglishFallback({
  ...
  meilisearch: {
    ...
    limit: "筆數",
    offset: "位移",
    resultSummary: "約 {count} 筆結果 · {time} 毫秒",
    viewJson: "JSON",
    viewTable: "表格",
    viewGrid: "網格",
    empty: "找不到文件",
  ...
  dataCompare: {
    ...
    ignoredColumns: "忽略欄位",
    ignoredColumnsPlaceholder: "以逗號分隔要忽略的欄位，如 created_at, updated_at",
    ignoredColumnsHint: "這些欄位的值差異不會列入比較；欄位仍會被讀取，並在新增資料列同步時保留其值；批次比較時全域套用至所有資料表。",
