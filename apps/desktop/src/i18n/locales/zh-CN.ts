...
export default withEnglishFallback({
  ...
  meilisearch: {
    ...
    limit: "条数",
    offset: "偏移",
    resultSummary: "约 {count} 条结果 · {time} 毫秒",
    viewJson: "JSON",
    viewTable: "表格",
    viewGrid: "网格",
    empty: "未找到文档",
  ...
  dataCompare: {
    ...
    ignoredColumns: "忽略字段",
    ignoredColumnsPlaceholder: "用逗号分隔要忽略的字段，如 created_at, updated_at",
    ignoredColumnsHint: "这些字段的值差异不参与比较；字段仍会被读取，并在新增行同步时保留其值；多表比较时全局应用。",
  ...
  settings: {
    ...
    sqlShortcutsDescription: "自定义在 SQL 编辑器中选中表名后执行的 SQL 模板。需先选中表名；建议使用含 Cmd/Ctrl 的组合键。",
    sqlShortcutsAdd: "添加",
    sqlShortcutsAddTitle: "添加 SQL 快捷键",
    sqlShortcutsEditTitle: "编辑 SQL 快捷键",
