...
export default withEnglishFallback({
  ...
  dataCompare: {
    ...
    ignoredColumns: "Columnas ignoradas",
    ignoredColumnsPlaceholder: "Columnas a ignorar separadas por comas, p. ej. created_at, updated_at",
    ignoredColumnsHint: "Las diferencias de valores en estas columnas se excluyen de la comparación. Las columnas se siguen leyendo y se conservan en las filas insertadas durante la sincronización; se aplica globalmente a todas las tablas comparadas.",
