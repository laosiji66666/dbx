...
export default withEnglishFallback({
  ...
  dataCompare: {
    ...
    ignoredColumns: "Colonne ignorate",
    ignoredColumnsPlaceholder: "Colonne da ignorare separate da virgola, es. created_at, updated_at",
    ignoredColumnsHint: "Le differenze di valori in queste colonne sono escluse dal confronto. Le colonne vengono comunque lette e mantenute nelle righe inserite durante la sincronizzazione; applicato globalmente a tutte le tabelle confrontate.",
