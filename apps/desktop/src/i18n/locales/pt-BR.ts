...
export default withEnglishFallback({
  ...
  meilisearch: {
    ...
    limit: "Limite",
    offset: "Deslocamento",
    resultSummary: "Cerca de {count} resultados · {time} ms",
    viewJson: "JSON",
    viewTable: "Tabela",
    viewGrid: "Grade",
  ...
  dataCompare: {
    ...
    ignoredColumns: "Colunas ignoradas",
    ignoredColumnsPlaceholder: "Colunas a serem ignoradas separadas por vírgula, ex.: created_at, updated_at",
    ignoredColumnsHint: "As diferenças de valores nessas colunas são excluídas da comparação. As colunas ainda são lidas e mantidas nas linhas inseridas durante a sincronização; aplicado globalmente a todas as tabelas comparadas.",
